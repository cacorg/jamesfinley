...
*/
add_filter('woocommerce_add_to_cart_fragments', 'mk_header_add_to_cart_fragment');
...
function remove_woocommerce_show_page_title() {
    return '';
}
add_filter( 'woocommerce_show_page_title', 'remove_woocommerce_show_page_title', 10, 3 );
