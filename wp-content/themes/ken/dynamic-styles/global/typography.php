...
$edge_slider_font_family = (!empty($mk_settings['edge-slider-title-font']['font-family'])) ? ('font-family:' . $mk_settings['edge-slider-title-font']['font-family'] . ';') : '';
$p_font_size = (!empty($mk_settings['p-text-size'])) ? $mk_settings['p-text-size'] : $mk_settings['body-font']['font-size'];
$heading_font_weight = isset($mk_settings['heading-font']['font-weight']) ? ('font-weight:'.$mk_settings['heading-font']['font-weight']) : '';
