...
$item_info = ob_get_contents();
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'subtitle' => __('', 'mk_framework'),
                        'desc'     => __('', 'mk_framework'),
                        'options'  => array('fullscreen' => 'Fullscreen', 'standard' => 'Standard', 'margin' => 'Margin', 'vertical' => 'Vertical'), //Must provide key => value pairs for radio options
                        'default'  => 'standard',
                    ),
                    array(
                        'id'       => 'fullheader-align',
                        'type'     => 'button_set',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'title'    => __('Full Screen Overlay Mode Alignment', 'mk_framework'),
                        'subtitle' => __('How you want the elements of the header aligned after the burger icon is clicked.', 'mk_framework'),
                        'desc'     => __('', 'mk_framework'),
                    ...
                    array(
                        ...
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'url'      => true,
                        'title'    => __('Full Screen Custom Logo', 'mk_framework'),
                        'mode'     => false,
                        'desc'     => __('', 'mk_framework'),
                        'subtitle' => __('If you want to show a different logo than your global header logo upload it here', 'mk_framework'),
                        'default'  => false,
                    ),
                    array(
                        'id'          => 'fullheader-font',
                        'type'        => 'typography',
                        'required'    => array('header-structure', 'equals', 'fullscreen'),
                        'title'       => __('Full Screen Header Menu Typography', 'mk_framework'),
                        ...
                        'subtitle'    => __('The font used for menu items. Note that this feature is only used for full screen menu items.', 'mk_framework'),
                        'default'     => array(
                    ...
                    array(
                        'id'       => 'fullheader-overlay-color',
                        'type'     => 'color',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'title'    => __('Full Screen Header Overlay BG Color', 'mk_framework'),
                        'subtitle' => __('The color of screen overlay', 'mk_framework'),
                        'default'  => '#565656',
                        'validate' => 'color',
                    ),
                    array(
                        'id'       => 'fullheader-overlay-opacity',
                        'type'     => 'slider',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'title'    => __('Full Screen Header Overlay Opacity', 'mk_framework'),
                        'subtitle' => __('The opacity of the screen overlay.', 'mk_framework'),
                        'desc'     => __('', 'mk_framework'),
                        "default"  => "100",
                        "min"      => "0",
                        "step"     => "1",
                    ...
                    array(
                        'id'       => 'fullheader-overlay-image',
                        'type'     => 'media',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'url'      => true,
                        'title'    => __('Full Screen Header Overlay BG Image', 'mk_framework'),
                        'subtitle' => __('If you want a background image for the overlay define it here.', 'mk_framework'),
                        'mode'     => false,
                        'desc'     => __('', 'mk_framework'),
                        'default'  => false,
                    ),
                    array(
                        'id'       => 'fullheader-link-hover-color',
                        'type'     => 'color',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'title'    => __('Full Screen Header Link Hover Color', 'mk_framework'),
                        'subtitle' => __('You can change the hover color of menu items (accent color by default)', 'mk_framework'),
                        'validate' => 'color',
                    ),
                    array(
                        'id'       => 'fullheader-link-bg-hover-color',
                        'type'     => 'color',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'title'    => __('Full Screen Header Link Background Hover Color', 'mk_framework'),
                        'subtitle' => __('You can change the hover background color of menu items', 'mk_framework'),
                        'validate' => 'color',
                    ),
                    array(
                        'id'       => 'fullheader-close-btn-color',
                        'type'     => 'color',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'title'    => __('Full Screen Header Close Button Color', 'mk_framework'),
                        'subtitle' => __('You can change the color of the close button', 'mk_framework'),
                        'validate' => 'color',
                        'default'  => '#ffffff',
                    ),
                    array(
                        'id'       => 'fullheader-burger-color',
                        'type'     => 'color',
                        'required' => array('header-structure', 'equals', 'fullscreen'),
                        'title'    => __('Full Screen Header Burger Icon Color', 'mk_framework'),
                        'subtitle' => __('You can change the color of Burger icon (White by default)', 'mk_framework'),
                        'validate' => 'color',
                        'default'  => '#222222',
                    ),
                    ...
                    array(
                        ...
                        'subtitle' => __('How you want the elements of the header aligned.', 'mk_framework'),
                        'desc'     => __('', 'mk_framework'),
                        'options'  => array('left' => 'Left', 'center' => 'Center', 'right' => 'Right'), //Must provide key => value pairs for radio options
                        'default'  => 'left',
                        'required' => array('header-structure', '!=', 'vertical'),
                    ),
                    array(
                        'id'       => 'nav-alignment',
                        'type'     => 'button_set',
                    ...
                    array(
                        'id'       => 'hide-mobile-header',
                        'type'     => 'switch',
                        'title'    => __('Show/Hide Header in Mobile Devices', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'desc'     => __('Using this option you can show/hide header for mobile devices (technically device screens smaller than 767px).', 'mk_framework'),
                        "default"  => 1,
                        'on'       => 'Show',
                        'off'      => 'Hide',
                    ),
            ...
            $this->sections[] = array(
                'title'  => __('Header Mobile', 'mk_framework'),
                'desc'   => __('', 'mk_framework'),
                'icon'   => 'el el-align-justify',
                'fields' => array(
                    array(
                        'id'       => 'mobile-burger-color',
                        'type'     => 'color',
                        'title'    => __('Burger Menu Icon Color', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'default'  => '',
                        'validate' => 'color',
                    ),
                    array(
                        'id'       => 'mobile-header-bg',
                        'type'     => 'color',
                        'title'    => __('Header Background Color', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'default'  => '',
                        'validate' => 'color',
                    ),
                    array(
                        ...
                        'type'     => 'color',
                        'title'    => __('Navigation Background Color', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'default'  => '',
                        'validate' => 'color',
                    ),
                    array(
                        ...
                        'type'     => 'color',
                        'title'    => __('Navigation Text Color', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'default'  => '',
                        'validate' => 'color',
                    ),
                    array(
                        'id'      => 'mobile-navigation-text-size',
                        'type'    => 'slider',
                        'title'   => __('Navigation Text Size', 'mk_framework'),
                        'desc'    => __('', 'mk_framework'),
                        "default" => "13",
                        "min"     => "5",
                        "step"    => "1",
                    ...
                    array(
                        'id'       => 'mobile-header-search-bg',
                        'type'     => 'color',
                        'title'    => __('Search Form Input Background Color', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'default'  => '',
                        'validate' => 'color',
                    ),
                    array(
                        'id'       => 'mobile-header-search-color',
                        'type'     => 'color',
                        'title'    => __('Search Form Input Text Color', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'default'  => '',
                        'validate' => 'color',
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'required' => array('side-dashboard', 'equals', '1'),
                        'type'     => 'text',
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'       => 'footer-width',
                        'type'     => 'button_set',
                        'title'    => __('Footer Width', 'mk_framework'),
                    ...
                    array(
                        'id'       => 'footer-padding',
                        'type'     => 'slider',
                        'title'    => __('Footer Padding', 'mk_framework'),
                        'subtitle' => __('Top & Bottom. default : 30px', 'mk_framework'),
                        'desc'     => __('Using this option you can increase or decrease footer padding from its top and bottom.', 'mk_framework'),
                        "default"  => "30",
                        "min"      => "0",
                        "step"     => "1",
                        "max"      => "200",
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'          => 'edge-slider-title-font',
                        'type'        => 'typography',
                        'title'       => __('Edge Slider Title', 'mk_framework'),
                        'compiler'    => false, // Use if you want to hook in your own CSS compiler
                        'google'      => true, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-style'  => false, // Includes font-style and weight. Can use font-style or font-weight to declare
                        ...
                        'all_styles'  => false, // Enable all Google Font style/weight variations to be added to the page
                        'units'       => 'px', // Defaults to px
                        'subtitle'    => __('Use this option to set a custom font family to Edge Slider titles', 'mk_framework'),
                        'default'     => array(
                            'font-family' => '',
                            'google'      => true,
                            'font-size'   => '13px',
                    ...
                    array(
                        ...
                        'type'           => 'typography',
                        'title'          => __('Footer Widget Title Font', 'mk_framework'),
                        'compiler'       => true, // Use if you want to hook in your own CSS compiler
                        'fonts'          => false,
                        'font-family'    => false,
                        'text-align'     => false,
                        'google'         => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup'    => false, // Select a backup non-google font in addition to a
                        'font-weight'    => true,
                        'font-style'     => false, // Includes font-style and weight. Can use font-style or font-weight to declare
                        'subsets'        => false, // Only appears if google is true and subsets not set to false
                        'font-size'      => true,
                        ...
                        'subtitle'       => __('This will apply to just footer widget areas title.', 'mk_framework'),
                    ),
                    array(
                        'id'      => 'footer-text-size',
                        'type'    => 'slider',
                        'title'   => __('Footer Text Size', 'mk_framework'),
                        'desc'    => __('', 'mk_framework'),
                        "default" => "13",
                        "min"     => "8",
                        "step"    => "1",
                    ...
                    array(
                        'id'      => 'subfooter-text-size',
                        'type'    => 'slider',
                        'title'   => __('Subfooter Text Size', 'mk_framework'),
                        'desc'    => __('', 'mk_framework'),
                        "default" => "13",
                        "min"     => "8",
                        "step"    => "1",
                    ...
                    array(
                        'id'      => 'subfooter-letter-spacing',
                        'type'    => 'slider',
                        'title'   => __('Subfooter Text Letter Spacing', 'mk_framework'),
                        'desc'    => __('', 'mk_framework'),
                        "default" => "0",
                        "min"     => "0",
                        "step"    => "1",
                    ...
                    array(
                        ...
                        'type'     => 'info',
                        'style'    => 'warning',
                        'desc'     => __("Note: Adobe Typekit is a premium service. <a target='_blank' href='https://themes.artbees.net/docs/integrating-typekit/'>Learn More</a>", 'mk_framework'),
                        'subtitle' => __("", 'mk_framework'),
                        'default'  => '',
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'       => 'archive-loop-image-height',
                        'type'     => 'slider',
                        'title'    => __('Archive Loop Featured Image Height', 'mk_framework'),
                        'subtitle' => __('', 'mk_framework'),
                        'desc'     => __('', 'mk_framework'),
                        "default"  => "350",
                        "min"      => "100",
  ...
  <li>You are done! You will need the following data later on:</ol>', 'mk_framework'),
                ...
                4. On the Credentials page, get a Browser key (and set the API Credentials).', 'mk_framework'),
                    ...
                    array(
                        ...
                        'type'     => 'text',
                        'title'    => __('MailChimp API Key', 'mk_framework'),
                        'desc'     => __('', 'mk_framework'),
                        'subtitle' => __('Enter your MailChimp API Key to get subscribers.', 'mk_framework'),
                        'default'  => '',
                    ),
                    array(
                        'id'       => 'typekit-id',
