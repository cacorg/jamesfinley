...
<div class="wp-install-template cp-pane">
	...
	<?php if ($mk_artbees_products->is_verified_artbees_customer()) : ?>
			...
			<div class="template-uploader">
				...
				<ol>
					<li><strong>Select and <a href="https://themes.artbees.net/template/" target="_blank">Download</a> your desired template.</strong></li>
		...
		<?php else : 
				echo mk_get_control_panel_view('register-product-popup', true, array('message' => 'In order to install new templates you must resgiter theme.<br> <a target="_blank" href="https://themes.artbees.net/docs/how-to-register-theme/">Learn how to register</a>')); 
			endif;
		?>
...
<!-- Files will be placed here -->
		...
		<hr/>
		<div class="how-to">
			<strong>Any problem? <a href="https://themes.artbees.net/docs/how-to-install-templates/" target="_blank">View the tutorial here</a></strong>
