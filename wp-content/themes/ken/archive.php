...
$loop_image_height = $mk_settings['archive-loop-image-height'];
		...
		<div class="theme-page-wrapper mk-main-wrapper <?php echo $layout; ?>-layout mk-grid vc_row-fluid">
			<div class="theme-content" itemprop="mainContentOfPage">
				...
				if ( isset( $_REQUEST['portfolio_category'] ) ) {
					echo do_shortcode( '[mk_portfolio style="'.$portfolio_loop_style.'" column="4" height="'.$loop_image_height.'" pagination_style="1"]' );
				} else {
					echo do_shortcode( '[mk_blog style="'.$loop_style.'" image_height="'.$loop_image_height.'" pagination_style="1"]' );
				}
	?>	
			</div>
