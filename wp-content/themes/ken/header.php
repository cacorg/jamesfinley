...
<?php
if($mk_settings['header-structure'] =='fullscreen'){
...
$fullscreen_bg_image= (!empty($mk_settings['fullheader-overlay-image']['url'])) ? ('background-image: url(' . $mk_settings['fullheader-overlay-image']['url']. ');') : '';
$fullscreen_overlay_color= (!empty($mk_settings['fullheader-overlay-color'])) ? ('background-color:' . $mk_settings['fullheader-overlay-color']. ';') : '';
$fullscreen_overlay_opacity= (!empty($mk_settings['fullheader-overlay-color'])) ? ('opacity:' . ($mk_settings['fullheader-overlay-opacity']/100). ';') : '';
$fullscreen_text_align= (!empty($mk_settings['fullheader-font']['text-align'])) ? ('text-align:' . $mk_settings['fullheader-font']['text-align']. ';') : '';
$fullscreen_font_family = (!empty($mk_settings['fullheader-font']['font-family'])) ? ('font-family:' . $mk_settings['fullheader-font']['font-family'] . ';') : '';
$fullscreen_font_size = (!empty($mk_settings['fullheader-font']['font-size'])) ? ('font-size:' . $mk_settings['fullheader-font']['font-size'] . ';') : '';
$fullscreen_font_weight = (!empty($mk_settings['fullheader-font']['font-weight'])) ? ('font-weight:' . $mk_settings['fullheader-font']['font-weight'] . ';') : '';
$fullscreen_line_height = (!empty($mk_settings['fullheader-font']['line-height'])) ? ('line-height:' . $mk_settings['fullheader-font']['line-height']. ';') : '';
$fullscreen_text_color = (!empty($mk_settings['fullheader-font']['color'])) ? ('color:' . $mk_settings['fullheader-font']['color']. ';') : '';
$fullscreen_text_hover_color = (!empty($mk_settings['fullheader-link-hover-color'])) ? ('color:' . $mk_settings['fullheader-link-hover-color']. ';') : '';

$fullscreen_bg_hover_color = (!empty($mk_settings['fullheader-link-bg-hover-color'])) ? ('background-color:' . $mk_settings['fullheader-link-bg-hover-color']. ';') : '';

$fullscreen_close_btn_color= (!empty($mk_settings['fullheader-close-btn-color'])) ? ('background-color:' . $mk_settings['fullheader-close-btn-color']. ';') : '';
$fullscreen_burger_btn_color= (!empty($mk_settings['fullheader-burger-color'])) ? ('background-color:' . $mk_settings['fullheader-burger-color']. ';') : '';
...
$app_styles .= '
    ...
    if($app_styles != '') {
      ...
      //TODO : addGlobalStyle doesn't work even when cache is clear
      //Mk_Static_Files::addGlobalStyle($app_styles);
...
if($mk_settings['header-structure'] == 'fullscreen'){
  do_action( 'fullscreen_container' , $mk_menu_location);
}
...
if(isset($mk_settings['hide-mobile-header']) && $mk_settings['hide-mobile-header'] == 0){
  $header_class .= ' hide-on-mobile ';
}
...
<?php
  ...
  if($mk_settings['boxed-header'] && $mk_settings['header-structure'] != 'vertical') {
    echo '<div class="mk-grid">';
      ...
      do_action( 'fullscreen_navigation', $mk_menu_location );
