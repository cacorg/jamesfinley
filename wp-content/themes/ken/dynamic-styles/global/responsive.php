...
$mobile_burger_color = (!empty($mk_settings['mobile-burger-color'])) ? 'background-color: '.$mk_settings['mobile-burger-color'].' !important;' : '';

$mobile_header_bg = (!empty($mk_settings['mobile-header-bg'])) ? 'background-color: '.$mk_settings['mobile-header-bg'].' !important;' : '';

$mobile_navigation_bg = (!empty($mk_settings['mobile-navigation-bg'])) ? 'background-color: '.$mk_settings['mobile-navigation-bg'].' !important;' : '';

$mobile_navigation_text_color = (!empty($mk_settings['mobile-navigation-text-color'])) ? 'color: '.$mk_settings['mobile-navigation-text-color'].' !important;' : '';

$mobile_navigation_text_size = (!empty($mk_settings['mobile-navigation-text-size'])) ? 'font-size: '.$mk_settings['mobile-navigation-text-size'].'px !important;line-height: 1.6em;' : '';

$mobile_header_search_bg = (!empty($mk_settings['mobile-header-search-bg'])) ? 'background-color: '.$mk_settings['mobile-header-search-bg'].' !important;' : '';

$mobile_header_search_color = (!empty($mk_settings['mobile-header-search-color'])) ? 'color: '.$mk_settings['mobile-header-search-color'].' !important;' : '';
...
@media handheld, only screen and (max-width: {$mk_settings['res-nav-width']}px) {
	...
	.mk-responsive-nav li a{
		{$mobile_navigation_text_size}
	}
	.header-searchform-input input[type=text]{
		{$mobile_header_search_bg}
		{$mobile_header_search_color}
	}
