...
class Theme
{
    ...
    public function functions()
    {
        ...
        require_once THEME_FRAMEWORK . "/visual-composer/init.php";
        ...
        require_once locate_template("portfolio-styles/nudge.php");
    ...
    public function admin()
    {
        if (is_admin()) {
            ...
            require_once THEME_FRAMEWORK . "/menus-custom-fields/menu-item-custom-fields.php";
